...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SmallCNN on calamity dataset")
    ...
    parser.add_argument("--save-path", default="models/smallcnn.pth", help="Path to save model weights")
    parser.add_argument(
...
def main() -> None:
    ...
    print(f"Training SmallCNN on {device}")
    ...
    print(f"Saved SmallCNN weights to: {save_path}")
